...
public class MainActivity extends AppCompatActivity {
    ...
    //다른 스레드에서 메세지를 받아서 UI 를 업데이트할 Handler 객체
    ...
    public void makeHttpRequest(String url){
        ...
        new RequstThread(url).start();
    }
    class RequstThread extends Thread{
        String url;
        //생성자
        public RequstThread(String url){
            this.url=url;
        }
        @Override
        public void run() {
            ...
            //UI 스레드(Main Thread) 가 아닌곳에서 UI 를 업데이트하는 것은 위험하다
